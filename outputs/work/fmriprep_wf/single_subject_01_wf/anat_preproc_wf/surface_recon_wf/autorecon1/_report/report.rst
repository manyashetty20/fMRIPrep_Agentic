Node: single_subject_01_wf (anat_preproc_wf (surface_recon_wf (autorecon1 (freesurfer)
======================================================================================


 Hierarchy : fmriprep_wf.single_subject_01_wf.anat_preproc_wf.surface_recon_wf.autorecon1
 Exec ID : autorecon1
...
* T1_files : ['/out/work/fmriprep_wf/single_subject_01_wf/anat_preproc_wf/anat_validate/sub-01_T1w_ras_valid.nii.gz']
* T2_file : <undefined>
* args : <undefined>
...
* BA_stats : <undefined>
* T1 : /out/freesurfer/sub-01/mri/T1.mgz
* annot : <undefined>
...
* prev_wd : /tmp
* working_dir : /out/work/fmriprep_wf/single_subject_01_wf/anat_preproc_wf/surface_recon_wf/autorecon1
